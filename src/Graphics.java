...
public class Graphics extends JPanel implements Runnable {
	...
	public void paint(java.awt.Graphics g) {
		...
		Image image = Toolkit.getDefaultToolkit().getImage("src/logo.png");
		g.drawImage(image, dim/2 - 50, 10, 300, 125, this);
...
//		g.setColor(Color.CYAN);
		g.drawString("  " + tournament.results().get(5).get(0), q1x + 5*x, q1y + (int)(y*(7.5*1.29)));
